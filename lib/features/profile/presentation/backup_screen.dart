  ...
  Future<void> _performRestore({
    ...
    try {
      ...
      await ref
          ...
          .restore(
            semesters
                .map((e) => Semester.fromMap(Map<String, dynamic>.from(e)))
                .toList(),
          );
      await ref
      ...
      await ref
          ...
          .restore(
            programmes
                .map((e) => Programme.fromMap(Map<String, dynamic>.from(e)))
                .toList(),
          );
      // dependencies
      await ref
          ...
          .restore(
            dependencies
                .map(
                  (e) =>
                      SubjectDependency.fromMap(Map<String, dynamic>.from(e)),
                )
                .toList(),
          );
      // scenarios
      await ref
          .read(scenarioRepositoryProvider.notifier)
          .restore(
            scenarios
                .map(
                  (e) => SemesterScenario.fromMap(Map<String, dynamic>.from(e)),
                )
                .toList(),
          );
      // courses
      await ref
          ...
          .restore(
            courses
                .map(
                  (e) => PersonalCourse.fromMap(Map<String, dynamic>.from(e)),
                )
                .toList(),
          );
      // topics
      await ref
          ...
          .restore(
            topics
                .map((e) => Topic.fromMap(Map<String, dynamic>.from(e)))
                .toList(),
          );
      // resources
      await ref
          ...
          .restore(
            resources
                .map(
                  (e) => AcademicResource.fromMap(Map<String, dynamic>.from(e)),
                )
                .toList(),
          );

      // exams, assignments, notes
      final restoredExams = exams
          .map((e) => Exam.fromMap(Map<String, dynamic>.from(e)))
          .toList();
